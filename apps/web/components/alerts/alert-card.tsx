...
import { eventTitle, formatAlertDetails, formatTimestamp, severityLabel } from "@/lib/utils";
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-2">
        ...
        <p className="text-sm leading-relaxed">{formatAlertDetails(alert.details)}</p>
